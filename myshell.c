...
//START OF MY CODE
//Worked in collaboration with David Noursi
...
void choose_helper(char* cmd_buff) // FIX -- diff it
{
    char* args[200];
...
int main(int argc, char *argv[]) //FIX -- diff it
{
    char cmd_buff[MAX] = {'\0'};
